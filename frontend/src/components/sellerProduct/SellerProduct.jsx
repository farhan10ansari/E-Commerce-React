...
function SellerProduct({product,message,messageId,index,handleProductName,handlePrice,handleQuantity,handleDetails,handleImage,handleDelete,handleUpdate}) {
