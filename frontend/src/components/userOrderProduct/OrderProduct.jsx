...
function Product({ product,handleCancel,index}) {
    ...
    <div className="row g-0 m-2 product">
      ...
      <div className="col md-2 center cancelbutton" >
          <button className="btn btn-danger button rounded" onClick={(e)=>{handleCancel(index,product.order_id,product.product_id)}}>Cancel Order</button>
      </div>:<></>
     }
