...
const AdminHome = ({user}) => {
    ...
    const loadProduct = async (pagenumber) => {
        ...
        fetch("http://localhost:3333/getAdminProducts",{
            headers:{
                'Authorization':token,
    ...
    const handleSellerUsername=(e,index)=>{
        products[index].seller_username=e.target.value;
        setProducts([...products]);
    ...
    const handleUpdate=(product_id,index)=>{
        ...
        formData.append("seller_username",products[index].seller_username);
                    ...
                    <div className="row-12 mt-3">
                        {
                            ...
                            products.map((product,index) => {
                                return <AdminProduct product={product}  
                                                    ...
                                                    handleSellerUsername={handleSellerUsername}
